...
<td class="cellrowborder" valign="top" width="50.03999999999999%" headers="mcps1.2.3.1.2 "><p id="p1968715318284"><a name="p1968715318284"></a><a name="p1968715318284"></a><span>创建实例后，在实例状态进入运行中之前的状态</span><span>。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.03999999999999%" headers="mcps1.2.3.1.2 "><p id="p268753162820"><a name="p268753162820"></a><a name="p268753162820"></a><span>实例正在进行重启操作</span><span>。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.03999999999999%" headers="mcps1.2.3.1.2 "><p id="p46871831122811"><a name="p46871831122811"></a><a name="p46871831122811"></a><span>实例正在进行强制重启操作</span><span>。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.03999999999999%" headers="mcps1.2.3.1.2 "><p id="p1468810315284"><a name="p1468810315284"></a><a name="p1468810315284"></a><span>实例接收变更请求，开始进行变更操作</span><span>。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.03999999999999%" headers="mcps1.2.3.1.2 "><p id="p8688143172817"><a name="p8688143172817"></a><a name="p8688143172817"></a><span>实例被正常停止</span><span>。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.03999999999999%" headers="mcps1.2.3.1.2 "><p id="p1868863122816"><a name="p1868863122816"></a><a name="p1868863122816"></a><span>实例正在校验变更完成后的配置</span><span>。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.03999999999999%" headers="mcps1.2.3.1.2 "><p id="p5688113112815"><a name="p5688113112815"></a><a name="p5688113112815"></a><span>实例处于异常状态</span><span>。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.03999999999999%" headers="mcps1.2.3.1.2 "><p id="p20689193113289"><a name="p20689193113289"></a><a name="p20689193113289"></a><span>实例已被正常删除</span><span>。</span></p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p95261038297"><a name="p95261038297"></a><a name="p95261038297"></a><span>实例被正常停止</span><span>。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p952616314291"><a name="p952616314291"></a><a name="p952616314291"></a><span>实例处于异常状态</span><span>。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p152619312293"><a name="p152619312293"></a><a name="p152619312293"></a><span>实例已被正常删除</span><span>。</span></p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p1034623472910"><a name="p1034623472910"></a><a name="p1034623472910"></a><span>实例处于创建中，正在进行调度。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p93461134142915"><a name="p93461134142915"></a><a name="p93461134142915"></a><span>实例处于创建中，正在准备磁盘。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p14346234202914"><a name="p14346234202914"></a><a name="p14346234202914"></a><span>实例处于创建中，正在准备网络。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p93468346293"><a name="p93468346293"></a><a name="p93468346293"></a><span>实例处于创建中，正在内部创建。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p163468347295"><a name="p163468347295"></a><a name="p163468347295"></a><span>实例处于重启中。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p11346734162911"><a name="p11346734162911"></a><a name="p11346734162911"></a><span>实例处于重启中，正在下发重启。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p1334733410299"><a name="p1334733410299"></a><a name="p1334733410299"></a><span>实例处于重启中，开始内部重启。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p153472034132919"><a name="p153472034132919"></a><a name="p153472034132919"></a><span>实例处于强制重启中。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p13471734142911"><a name="p13471734142911"></a><a name="p13471734142911"></a><span>实例处于强制重启中，正在下发重启。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p1234753442910"><a name="p1234753442910"></a><a name="p1234753442910"></a><span>实例处于强制重启中，开始内部重启。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p113471734142917"><a name="p113471734142917"></a><a name="p113471734142917"></a><span>实例处于重建中。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p234714343292"><a name="p234714343292"></a><a name="p234714343292"></a><span>实例处于重建中，正在准备磁盘。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p3348113417294"><a name="p3348113417294"></a><a name="p3348113417294"></a><span>实例处于重建中，正在内部重建。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p1348153482912"><a name="p1348153482912"></a><a name="p1348153482912"></a><span>实例处于热迁移中。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p1534813422914"><a name="p1534813422914"></a><a name="p1534813422914"></a><span>实例处于调整规格中，正在准备阶段。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p634816340291"><a name="p634816340291"></a><a name="p634816340291"></a><span>实例处于调整规格中，正在迁移阶段。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p734812342294"><a name="p734812342294"></a><a name="p734812342294"></a><span>实例处于调整规格中，已经完成迁移。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p1434812349299"><a name="p1434812349299"></a><a name="p1434812349299"></a><span>实例处于调整规格中，正在完成调整。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p143481634132918"><a name="p143481634132918"></a><a name="p143481634132918"></a><span>实例处于调整规格中，正在回退调整。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p2348203402910"><a name="p2348203402910"></a><a name="p2348203402910"></a><span>实例处于停止中。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p183491834132917"><a name="p183491834132917"></a><a name="p183491834132917"></a><span>实例处于启动中。</span></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="58.32000000000001%" headers="mcps1.2.3.1.2 "><p id="p234923413298"><a name="p234923413298"></a><a name="p234923413298"></a><span>实例处于删除中。</span></p>
</td>
</tr>
</tbody>
</table>
