# 云服务器网卡解绑虚拟IP地址（废弃）<a name="ecs_02_050401"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ECS&api=DisassociateServerVirtualIp)中调试该接口。
...
<td class="cellrowborder" valign="top" width="40.22%" headers="mcps1.2.5.1.4 "><p id="p52170790174229"><a name="p52170790174229"></a><a name="p52170790174229"></a><span id="text02531285322"><a name="text02531285322"></a><a name="text02531285322"></a>云服务器</span>添加网卡的信息。</p>
...
<td class="cellrowborder" valign="top" width="40.22%" headers="mcps1.2.5.1.4 "><p id="p58632794204513"><a name="p58632794204513"></a><a name="p58632794204513"></a>网卡即将解绑的虚拟IP的地址。</p>
