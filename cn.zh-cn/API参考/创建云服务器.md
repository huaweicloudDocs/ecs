...
-   创建包年/包月云服务器资源后，请参考“[支付包年/包月产品订单](https://support.huaweicloud.com/api-bpconsole/api_order_00016.html)”进行支付。
-   若想使用优惠券，请将请求中的isAutoPay字段设置为false，参考“[支付包年/包月产品订单](https://support.huaweicloud.com/api-bpconsole/api_order_00016.html)”进行支付，或者在华为云官网页面使用优惠券进行支付。
...
<p id="p5764142116542"><a name="p5764142116542"></a><a name="p5764142116542"></a>创建包年/包月的弹性云服务器的时候，创建的系统盘/数据盘也是包年/包月，周期和弹性云服务器一致</p>
...
<td class="cellrowborder" valign="top" width="57.06%" headers="mcps1.2.5.1.4 "><p id="p7841627442"><a name="p7841627442"></a><a name="p7841627442"></a>待创建云服务器所在的可用区，需要指定可用分区名称。</p>
...
<td class="cellrowborder" valign="top" width="57.06%" headers="mcps1.2.5.1.4 "><p id="p17588155913384"><a name="p17588155913384"></a><a name="p17588155913384"></a>是否支持随机多AZ部署。</p>
...
<div class="note" id="zh-cn_topic_0020212668_note4876141782613"><a name="zh-cn_topic_0020212668_note4876141782613"></a><a name="zh-cn_topic_0020212668_note4876141782613"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="zh-cn_topic_0020212668_ul49971332368"></a><a name="zh-cn_topic_0020212668_ul49971332368"></a><ul id="zh-cn_topic_0020212668_ul49971332368"><li>最多可注入10对键值（Key/Value）。</li><li>主键（Key）只能由大写字母（A-Z）、小写字母（a-z）、数字（0-9）、中划线（-）、下划线（_）、冒号（:）、空格（ ）和小数点（.）组成，长度为[1-255]个字符。</li><li>值（value）最大长度为255个字符。</li></ul>
</div></div>
...
<div class="note" id="zh-cn_topic_0020212668_note187211802410"><a name="zh-cn_topic_0020212668_note187211802410"></a><a name="zh-cn_topic_0020212668_note187211802410"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="zh-cn_topic_0020212668_p3250223286"><a name="zh-cn_topic_0020212668_p3250223286"></a><a name="zh-cn_topic_0020212668_p3250223286"></a>对于SDI规格（包含c6x_4、c6ie_4、c7等规格），需要使用SCSI类型的卷，如果客户未指定该参数，SDI类型规格也会自动为客户创建SCSI类型磁盘；SDI类型规格请指定该参数为true或者不指定该参数。</p>
</div></div>
</td>
</tr>
</tbody>
...
<div class="note" id="zh-cn_topic_0020212668_note1279613227324"><a name="zh-cn_topic_0020212668_note1279613227324"></a><a name="zh-cn_topic_0020212668_note1279613227324"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="zh-cn_topic_0020212668_zh-cn_topic_0020212668_p3250223286"><a name="zh-cn_topic_0020212668_zh-cn_topic_0020212668_p3250223286"></a><a name="zh-cn_topic_0020212668_zh-cn_topic_0020212668_p3250223286"></a>对于SDI规格（包含c6x_4、c6ie_4、c7等规格），需要使用SCSI类型的卷，如果客户未指定该参数，SDI类型规格也会自动为客户创建SCSI类型磁盘；SDI类型规格请指定该参数为true或者不指定该参数。</p>
</div></div>
</td>
</tr>
