...
<div class="note" id="note115818716553"><a name="note115818716553"></a><a name="note115818716553"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p131587725513"><a name="p131587725513"></a><a name="p131587725513"></a>当前仅支持反亲和性anti-affinity策略。如果使用其他策略云服务器组会创建失败。</p>
</div></div>
</td>
</tr>
</tbody>
