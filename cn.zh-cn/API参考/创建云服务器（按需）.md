...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ECS&api=CreatePostPaidServers)中直接运行调试该接口。
...
<td class="cellrowborder" valign="top" width="59.87128712871287%" headers="mcps1.2.5.1.4 "><p id="p124835165514"><a name="p124835165514"></a><a name="p124835165514"></a>创建<span id="text86731033192216"><a name="text86731033192216"></a><a name="text86731033192216"></a>云服务器</span>过程中待注入用户数据。支持注入文本、文本文件。</p>
...
<td class="cellrowborder" valign="top" width="59.87128712871287%" headers="mcps1.2.5.1.4 "><p id="p17561731155214"><a name="p17561731155214"></a><a name="p17561731155214"></a>配置<span id="text5493108192211"><a name="text5493108192211"></a><a name="text5493108192211"></a>云服务器</span>的弹性IP信息，弹性IP有三种配置方式。</p>
...
<td class="cellrowborder" valign="top" width="59.87128712871287%" headers="mcps1.2.5.1.4 "><p id="p1059113114525"><a name="p1059113114525"></a><a name="p1059113114525"></a>待创建<span id="text46718172227"><a name="text46718172227"></a><a name="text46718172227"></a>云服务器</span>所在的可用区，需要指定 可用分区名称。</p>
...
<td class="cellrowborder" valign="top" width="12.346534653465346%" headers="mcps1.2.5.1.3 "><p id="p1955131412912"><a name="p1955131412912"></a><a name="p1955131412912"></a>Object</p>
</td>
...
<td class="cellrowborder" valign="top" width="12.346534653465346%" headers="mcps1.2.5.1.3 "><p id="p1930163414299"><a name="p1930163414299"></a><a name="p1930163414299"></a>Array of strings</p>
</td>
...
<th class="cellrowborder" valign="top" width="12.396039603960396%" id="mcps1.2.5.1.2"><p id="p97891040194210"><a name="p97891040194210"></a><a name="p97891040194210"></a>是否必选</p>
</th>
<th class="cellrowborder" valign="top" width="12.811881188118809%" id="mcps1.2.5.1.3"><p id="p1478994020422"><a name="p1478994020422"></a><a name="p1478994020422"></a>参数类型</p>
</th>
...
<td class="cellrowborder" valign="top" width="12.396039603960396%" headers="mcps1.2.5.1.2 "><p id="p24837051"><a name="p24837051"></a><a name="p24837051"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="12.811881188118809%" headers="mcps1.2.5.1.3 "><p id="p65644149"><a name="p65644149"></a><a name="p65644149"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" width="12.396039603960396%" headers="mcps1.2.5.1.2 "><p id="p39934810104313"><a name="p39934810104313"></a><a name="p39934810104313"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="12.811881188118809%" headers="mcps1.2.5.1.3 "><p id="p13494158104313"><a name="p13494158104313"></a><a name="p13494158104313"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" width="12.396039603960396%" headers="mcps1.2.5.1.2 "><p id="p677791510531"><a name="p677791510531"></a><a name="p677791510531"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="12.811881188118809%" headers="mcps1.2.5.1.3 "><p id="p47771915145316"><a name="p47771915145316"></a><a name="p47771915145316"></a>Boolean</p>
</td>
...
<td class="cellrowborder" valign="top" width="12.396039603960396%" headers="mcps1.2.5.1.2 "><p id="p76741256185711"><a name="p76741256185711"></a><a name="p76741256185711"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="12.811881188118809%" headers="mcps1.2.5.1.3 "><p id="p1267412565578"><a name="p1267412565578"></a><a name="p1267412565578"></a>Object</p>
</td>
...
<td class="cellrowborder" valign="top" width="60.9%" headers="mcps1.2.5.1.4 "><p id="p157213814240"><a name="p157213814240"></a><a name="p157213814240"></a>使用SDI规格创建虚拟机时请关注该参数，如果该参数值为true，说明创建的为scsi类型的卷；</p>
...
<td class="cellrowborder" valign="top" width="60.3%" headers="mcps1.2.5.1.4 "><p id="p4088945310517"><a name="p4088945310517"></a><a name="p4088945310517"></a>数据卷是否使用SCSI锁。</p>
