...
<td class="cellrowborder" valign="top" width="57.415841584158414%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0057972661_p6993202"><a name="zh-cn_topic_0057972661_p6993202"></a><a name="zh-cn_topic_0057972661_p6993202"></a><span id="text2464154414511"><a name="text2464154414511"></a><a name="text2464154414511"></a>弹性云服务器</span>信息，请参见<a href="#table761103195216">表3</a>。</p>
</td>
</tr>
<tr id="row1127773764718"><td class="cellrowborder" valign="top" width="17.15841584158416%" headers="mcps1.2.5.1.1 "><p id="p531711654214"><a name="p531711654214"></a><a name="p531711654214"></a>dry_run</p>
</td>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p15183125212"><a name="p15183125212"></a><a name="p15183125212"></a>待创建<span id="text18270358214"><a name="text18270358214"></a><a name="text18270358214"></a>云服务器</span>的系统镜像，需要指定已创建镜像的ID，ID格式为通用唯一识别码（Universally Unique Identifier，简称UUID）。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p124996526158"><a name="p124996526158"></a><a name="p124996526158"></a>待创建<span id="text197803388219"><a name="text197803388219"></a><a name="text197803388219"></a>云服务器</span>的系统规格的ID。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p968256115212"><a name="p968256115212"></a><a name="p968256115212"></a>创建<span id="text135721250132115"><a name="text135721250132115"></a><a name="text135721250132115"></a>云服务器</span>过程中待注入用户数据。支持注入文本、文本文件。</p>
...
<a name="ul20513113015159"></a><a name="ul20513113015159"></a><ul id="ul20513113015159"><li>注入内容，需要进行base64格式编码。注入内容（编码之前的内容）最大长度32KB。</li><li>创建密码方式鉴权的Linux<span id="text1319375024517"><a name="text1319375024517"></a><a name="text1319375024517"></a>弹性云服务器</span>时，该字段可为root用户注入自定义初始化密码，具体注入密码的使用方法请参见<a href="#section61372619">功能介绍</a>。</li></ul>
<p id="p1356123019157"><a name="p1356123019157"></a><a name="p1356123019157"></a>示例（base64编码前）：</p>
<a name="ul18511102323114"></a><a name="ul18511102323114"></a><ul id="ul18511102323114"><li>Linux<span id="text2020005116451"><a name="text2020005116451"></a><a name="text2020005116451"></a>弹性云服务器</span><pre class="screen" id="screen193519572312"><a name="screen193519572312"></a><a name="screen193519572312"></a>#! /bin/bash
echo user_test &gt;&gt; /home/user.txt </pre>
</li><li>Windows<span id="text549185214456"><a name="text549185214456"></a><a name="text549185214456"></a>弹性云服务器</span><pre class="screen" id="screen14888143719322"><a name="screen14888143719322"></a><a name="screen14888143719322"></a>rem cmd
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p055153115217"><a name="p055153115217"></a><a name="p055153115217"></a>如果需要使用SSH密钥方式登录<span id="text4452161102213"><a name="text4452161102213"></a><a name="text4452161102213"></a>云服务器</span>，请指定已创建密钥的名称。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p5551731125218"><a name="p5551731125218"></a><a name="p5551731125218"></a>待创建<span id="text79086218229"><a name="text79086218229"></a><a name="text79086218229"></a>云服务器</span>所属虚拟私有云（简称VPC），需要指定已创建VPC的ID，UUID格式。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p1756731175216"><a name="p1756731175216"></a><a name="p1756731175216"></a>待创建<span id="text104131061221"><a name="text104131061221"></a><a name="text104131061221"></a>云服务器</span>的网卡信息。详情请参见<a href="#table9120223">表4</a>。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p17561731155214"><a name="p17561731155214"></a><a name="p17561731155214"></a>配置<span id="text5493108192211"><a name="text5493108192211"></a><a name="text5493108192211"></a>云服务器</span>的弹性IP信息，弹性IP有三种配置方式。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p1157203120522"><a name="p1157203120522"></a><a name="p1157203120522"></a>创建<span id="text545219916220"><a name="text545219916220"></a><a name="text545219916220"></a>云服务器</span>数量。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p4438183818317"><a name="p4438183818317"></a><a name="p4438183818317"></a>当批量创建弹性云服务器时，<span id="text175731011220"><a name="text175731011220"></a><a name="text175731011220"></a>云服务器</span>名称是否允许重名，当count大于1的时候该参数生效。默认为False。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p17571031115215"><a name="p17571031115215"></a><a name="p17571031115215"></a><span id="text538119128221"><a name="text538119128221"></a><a name="text538119128221"></a>云服务器</span>对应系统盘相关配置。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p4581031115217"><a name="p4581031115217"></a><a name="p4581031115217"></a><span id="text1458721342218"><a name="text1458721342218"></a><a name="text1458721342218"></a>云服务器</span>对应数据盘相关配置。每一个数据结构代表一块待创建的数据盘。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p1059123112521"><a name="p1059123112521"></a><a name="p1059123112521"></a><span id="text515571517226"><a name="text515571517226"></a><a name="text515571517226"></a>云服务器</span>对应安全组信息。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p1059113114525"><a name="p1059113114525"></a><a name="p1059113114525"></a>待创建<span id="text46718172227"><a name="text46718172227"></a><a name="text46718172227"></a>云服务器</span>所在的可用区，需要指定可用区（AZ）的名称。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p759143185217"><a name="p759143185217"></a><a name="p759143185217"></a>创建<span id="text386761772217"><a name="text386761772217"></a><a name="text386761772217"></a>云服务器</span>附加信息。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p10776101515307"><a name="p10776101515307"></a><a name="p10776101515307"></a>创建<span id="text92834208223"><a name="text92834208223"></a><a name="text92834208223"></a>云服务器</span>元数据。</p>
<p id="p1121831194215"><a name="p1121831194215"></a><a name="p1121831194215"></a>可以通过元数据自定义键值对。</p>
<div class="note" id="note16513182016343"><a name="note16513182016343"></a><a name="note16513182016343"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul13514820153415"></a><a name="ul13514820153415"></a><ul id="ul13514820153415"><li>最多可注入10对键值（Key/Value）。</li><li>主键（Key）只能由大写字母（A-Z）、小写字母（a-z）、数字（0-9）、中划线（-）、下划线（_）、冒号（:）和小数点（.）组成，长度为[1-255]个字符。</li><li>值（value）最大长度为255个字符。</li></ul>
</div></div>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p116011319521"><a name="p116011319521"></a><a name="p116011319521"></a><span id="text3916225221"><a name="text3916225221"></a><a name="text3916225221"></a>云服务器</span>调度信息，例如设置云服务器组。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p20611731185211"><a name="p20611731185211"></a><a name="p20611731185211"></a><span id="text18511254174517"><a name="text18511254174517"></a><a name="text18511254174517"></a>弹性云服务器</span>的标签。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p1163015489281"><a name="p1163015489281"></a><a name="p1163015489281"></a><span id="text16697115617456"><a name="text16697115617456"></a><a name="text16697115617456"></a>弹性云服务器</span>的标签。详情请参见<a href="数据结构(创建云服务器).md#table166725488304">表14</a>。</p>
...
<td class="cellrowborder" valign="top" width="57.55445544554456%" headers="mcps1.2.5.1.4 "><p id="p15756848134113"><a name="p15756848134113"></a><a name="p15756848134113"></a><span id="text18595132813226"><a name="text18595132813226"></a><a name="text18595132813226"></a>云服务器</span>描述信息，默认为空字符串。</p>
...
<td class="cellrowborder" valign="top" width="56.43564356435644%" headers="mcps1.2.5.1.4 "><p id="p52170790174229"><a name="p52170790174229"></a><a name="p52170790174229"></a>待创建<span id="text1290819290226"><a name="text1290819290226"></a><a name="text1290819290226"></a>云服务器</span>所在的子网信息。</p>
...
<td class="cellrowborder" valign="top" width="56.43564356435644%" headers="mcps1.2.5.1.4 "><p id="p28930193174245"><a name="p28930193174245"></a><a name="p28930193174245"></a>待创建<span id="text186606305226"><a name="text186606305226"></a><a name="text186606305226"></a>云服务器</span>网卡的IP地址，IPv4格式。</p>
...
<td class="cellrowborder" valign="top" width="47%" headers="mcps1.2.5.1.4 "><p id="p54864902"><a name="p54864902"></a><a name="p54864902"></a><span id="text9318163212218"><a name="text9318163212218"></a><a name="text9318163212218"></a>云服务器</span>系统盘对应的磁盘类型，需要与系统所提供的磁盘类型相匹配。</p>
...
<div class="note" id="note3285292094120"><a name="note3285292094120"></a><a name="note3285292094120"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p2724083194120"><a name="p2724083194120"></a><a name="p2724083194120"></a>了解不同磁盘类型的详细信息，请参见<a href="https://support.huaweicloud.com/productdesc-evs/zh-cn_topic_0044524691.html" target="_blank" rel="noopener noreferrer">磁盘类型及性能介绍</a>。</p>
</div></div>
</td>
</tr>
...
<tr id="row1941194120923"><td class="cellrowborder" valign="top" width="18.060000000000002%" headers="mcps1.2.5.1.1 "><p id="p2886339020923"><a name="p2886339020923"></a><a name="p2886339020923"></a>cluster_type</p>
</td>
<td class="cellrowborder" valign="top" width="17.02%" headers="mcps1.2.5.1.2 "><p id="p5623328820923"><a name="p5623328820923"></a><a name="p5623328820923"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="17.919999999999998%" headers="mcps1.2.5.1.3 "><p id="p5860250720923"><a name="p5860250720923"></a><a name="p5860250720923"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="47%" headers="mcps1.2.5.1.4 "><p id="p4918260620923"><a name="p4918260620923"></a><a name="p4918260620923"></a><span id="text1315123610224"><a name="text1315123610224"></a><a name="text1315123610224"></a>云服务器</span>系统盘对应的磁盘存储类型。</p>
...
<tr id="row54482489201022"><td class="cellrowborder" valign="top" width="18.060000000000002%" headers="mcps1.2.5.1.1 "><p id="p51005521201022"><a name="p51005521201022"></a><a name="p51005521201022"></a>cluster_id</p>
</td>
<td class="cellrowborder" valign="top" width="17.02%" headers="mcps1.2.5.1.2 "><p id="p37806521201022"><a name="p37806521201022"></a><a name="p37806521201022"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="17.919999999999998%" headers="mcps1.2.5.1.3 "><p id="p42429337201022"><a name="p42429337201022"></a><a name="p42429337201022"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="47%" headers="mcps1.2.5.1.4 "><p id="p14224282201022"><a name="p14224282201022"></a><a name="p14224282201022"></a><span id="text19188173715224"><a name="text19188173715224"></a><a name="text19188173715224"></a>云服务器</span>系统盘对应的存储池的ID。</p>
</td>
</tr>
...
<table><thead align="left"><tr id="row64470080"><th class="cellrowborder" valign="top" width="19.56%" id="mcps1.2.5.1.1"><p id="p11191618194312"><a name="p11191618194312"></a><a name="p11191618194312"></a>参数</p>
</th>
<th class="cellrowborder" valign="top" width="15.82%" id="mcps1.2.5.1.2"><p id="p911916181439"><a name="p911916181439"></a><a name="p911916181439"></a>是否必选</p>
</th>
...
<tbody><tr id="row11410990"><td class="cellrowborder" valign="top" width="19.56%" headers="mcps1.2.5.1.1 "><p id="p51874972"><a name="p51874972"></a><a name="p51874972"></a>volumetype</p>
</td>
<td class="cellrowborder" valign="top" width="15.82%" headers="mcps1.2.5.1.2 "><p id="p41123170"><a name="p41123170"></a><a name="p41123170"></a>是</p>
</td>
...
<td class="cellrowborder" valign="top" width="46.800000000000004%" headers="mcps1.2.5.1.4 "><p id="p31488280"><a name="p31488280"></a><a name="p31488280"></a><span id="text11963737192218"><a name="text11963737192218"></a><a name="text11963737192218"></a>云服务器</span>数据盘对应的磁盘类型，需要与系统所提供的磁盘类型相匹配。</p>
...
<div class="note" id="note1596111818210"><a name="note1596111818210"></a><a name="note1596111818210"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="zh-cn_topic_0020212668_p2724083194120"><a name="zh-cn_topic_0020212668_p2724083194120"></a><a name="zh-cn_topic_0020212668_p2724083194120"></a>了解不同磁盘类型的详细信息，请参见<a href="https://support.huaweicloud.com/productdesc-evs/zh-cn_topic_0044524691.html" target="_blank" rel="noopener noreferrer">磁盘类型及性能介绍</a>。</p>
</div></div>
</td>
</tr>
<tr id="row14959071"><td class="cellrowborder" valign="top" width="19.56%" headers="mcps1.2.5.1.1 "><p id="p3725214"><a name="p3725214"></a><a name="p3725214"></a>size</p>
</td>
<td class="cellrowborder" valign="top" width="15.82%" headers="mcps1.2.5.1.2 "><p id="p33306906"><a name="p33306906"></a><a name="p33306906"></a>是</p>
</td>
...
<tr id="row36319805104741"><td class="cellrowborder" valign="top" width="19.56%" headers="mcps1.2.5.1.1 "><p id="p58442796104741"><a name="p58442796104741"></a><a name="p58442796104741"></a>shareable</p>
</td>
<td class="cellrowborder" valign="top" width="15.82%" headers="mcps1.2.5.1.2 "><p id="p36246068104741"><a name="p36246068104741"></a><a name="p36246068104741"></a>否</p>
</td>
...
<tr id="row5795350214188"><td class="cellrowborder" valign="top" width="19.56%" headers="mcps1.2.5.1.1 "><p id="p5181947414188"><a name="p5181947414188"></a><a name="p5181947414188"></a>multiattach</p>
</td>
<td class="cellrowborder" valign="top" width="15.82%" headers="mcps1.2.5.1.2 "><p id="p3662789014188"><a name="p3662789014188"></a><a name="p3662789014188"></a>否</p>
</td>
...
<tr id="row1051569714183"><td class="cellrowborder" valign="top" width="19.56%" headers="mcps1.2.5.1.1 "><p id="p2753241214183"><a name="p2753241214183"></a><a name="p2753241214183"></a>hw:passthrough</p>
</td>
<td class="cellrowborder" valign="top" width="15.82%" headers="mcps1.2.5.1.2 "><p id="p1553286914183"><a name="p1553286914183"></a><a name="p1553286914183"></a>否</p>
</td>
...
<tr id="row26398748122322"><td class="cellrowborder" valign="top" width="19.56%" headers="mcps1.2.5.1.1 "><p id="p48878066122327"><a name="p48878066122327"></a><a name="p48878066122327"></a>extendparam</p>
</td>
<td class="cellrowborder" valign="top" width="15.82%" headers="mcps1.2.5.1.2 "><p id="p66809250122327"><a name="p66809250122327"></a><a name="p66809250122327"></a>否</p>
</td>
...
<tr id="row44928373202040"><td class="cellrowborder" valign="top" width="19.56%" headers="mcps1.2.5.1.1 "><p id="p26289818202046"><a name="p26289818202046"></a><a name="p26289818202046"></a>cluster_type</p>
</td>
<td class="cellrowborder" valign="top" width="15.82%" headers="mcps1.2.5.1.2 "><p id="p49100499202046"><a name="p49100499202046"></a><a name="p49100499202046"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="17.82%" headers="mcps1.2.5.1.3 "><p id="p17717481202046"><a name="p17717481202046"></a><a name="p17717481202046"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="46.800000000000004%" headers="mcps1.2.5.1.4 "><p id="p25829827202046"><a name="p25829827202046"></a><a name="p25829827202046"></a><span id="text163323432222"><a name="text163323432222"></a><a name="text163323432222"></a>云服务器</span>数据盘对应的磁盘存储类型。</p>
...
<tr id="row50881230202044"><td class="cellrowborder" valign="top" width="19.56%" headers="mcps1.2.5.1.1 "><p id="p42319117202046"><a name="p42319117202046"></a><a name="p42319117202046"></a>cluster_id</p>
</td>
<td class="cellrowborder" valign="top" width="15.82%" headers="mcps1.2.5.1.2 "><p id="p5296482202046"><a name="p5296482202046"></a><a name="p5296482202046"></a>否</p>
</td>
<td class="cellrowborder" valign="top" width="17.82%" headers="mcps1.2.5.1.3 "><p id="p26361920202046"><a name="p26361920202046"></a><a name="p26361920202046"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="46.800000000000004%" headers="mcps1.2.5.1.4 "><p id="p54940750202046"><a name="p54940750202046"></a><a name="p54940750202046"></a><span id="text1126284415228"><a name="text1126284415228"></a><a name="text1126284415228"></a>云服务器</span>数据盘对应的存储池的ID。</p>
</td>
</tr>
<tr id="row62177020217"><td class="cellrowborder" valign="top" width="19.56%" headers="mcps1.2.5.1.1 "><p id="p5036340620217"><a name="p5036340620217"></a><a name="p5036340620217"></a>data_image_id</p>
</td>
<td class="cellrowborder" valign="top" width="15.82%" headers="mcps1.2.5.1.2 "><p id="p5290411520217"><a name="p5290411520217"></a><a name="p5290411520217"></a>否</p>
</td>
...
<tr id="row17444062585"><td class="cellrowborder" valign="top" width="19.56%" headers="mcps1.2.5.1.1 "><p id="p164461462581"><a name="p164461462581"></a><a name="p164461462581"></a>metadata</p>
</td>
<td class="cellrowborder" valign="top" width="15.82%" headers="mcps1.2.5.1.2 "><p id="p174476613587"><a name="p174476613587"></a><a name="p174476613587"></a>否</p>
</td>
...
<table><thead align="left"><tr id="row11825193111915"><th class="cellrowborder" valign="top" width="23.34%" id="mcps1.1.4.1.1"><p id="p135632102272"><a name="p135632102272"></a><a name="p135632102272"></a>参数</p>
</th>
<th class="cellrowborder" valign="top" width="23.400000000000002%" id="mcps1.1.4.1.2"><p id="p55632010102714"><a name="p55632010102714"></a><a name="p55632010102714"></a>参数类型</p>
</th>
<th class="cellrowborder" valign="top" width="53.26%" id="mcps1.1.4.1.3"><p id="p125631410152717"><a name="p125631410152717"></a><a name="p125631410152717"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="row382615381910"><td class="cellrowborder" valign="top" width="23.34%" headers="mcps1.1.4.1.1 "><p id="p1882713151914"><a name="p1882713151914"></a><a name="p1882713151914"></a>job_id</p>
</td>
<td class="cellrowborder" valign="top" width="23.400000000000002%" headers="mcps1.1.4.1.2 "><p id="p1182723161913"><a name="p1182723161913"></a><a name="p1182723161913"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="53.26%" headers="mcps1.1.4.1.3 "><p id="p12827133121914"><a name="p12827133121914"></a><a name="p12827133121914"></a>提交任务成功后返回的任务ID，用户可以使用该ID对任务执行情况进行查询。如何根据job_id来查询Job的执行状态，请参考<a href="查询Job状态.md">5.8 查询Job状态。</a></p>
</td>
</tr>
<tr id="row582720317197"><td class="cellrowborder" valign="top" width="23.34%" headers="mcps1.1.4.1.1 "><p id="p282873131918"><a name="p282873131918"></a><a name="p282873131918"></a>serverIds</p>
</td>
<td class="cellrowborder" valign="top" width="23.400000000000002%" headers="mcps1.1.4.1.2 "><p id="p1582818371912"><a name="p1582818371912"></a><a name="p1582818371912"></a>Array of strings</p>
</td>
<td class="cellrowborder" valign="top" width="53.26%" headers="mcps1.1.4.1.3 "><p id="p14666221162912"><a name="p14666221162912"></a><a name="p14666221162912"></a><span id="text18205645182215"><a name="text18205645182215"></a><a name="text18205645182215"></a>云服务器</span>ID列表。</p>
