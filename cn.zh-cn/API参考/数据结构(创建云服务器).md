...
-   [创建的extendparam字段数据结构说明](#section9232164884010)
...
<td class="cellrowborder" valign="top" width="47.56%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0020212668_p36517316174333"><a name="zh-cn_topic_0020212668_p36517316174333"></a><a name="zh-cn_topic_0020212668_p36517316174333"></a>为待创建<span id="text480322220575"><a name="text480322220575"></a><a name="text480322220575"></a>云服务器</span>分配已有时，分配的的ID，UUID格式。</p>
<p id="zh-cn_topic_0020212668_p60220392174333"><a name="zh-cn_topic_0020212668_p60220392174333"></a><a name="zh-cn_topic_0020212668_p60220392174333"></a>约束：只能分配状态（status）为DOWN的。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="47.56%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0020212668_p2073067610201"><a name="zh-cn_topic_0020212668_p2073067610201"></a><a name="zh-cn_topic_0020212668_p2073067610201"></a>配置<span id="text2064262319575"><a name="text2064262319575"></a><a name="text2064262319575"></a>云服务器</span>自动分配时，创建的配置参数。</p>
...
<td class="cellrowborder" valign="top" width="47.36526347365263%" headers="mcps1.2.5.1.4 "><p id="p142060437155"><a name="p142060437155"></a><a name="p142060437155"></a>地址类型。</p>
...
<td class="cellrowborder" valign="top" width="47.36526347365263%" headers="mcps1.2.5.1.4 "><p id="p920618437151"><a name="p920618437151"></a><a name="p920618437151"></a>地址带宽参数。</p>
...
<td class="cellrowborder" valign="top" width="47.36526347365263%" headers="mcps1.2.5.1.4 "><p id="p92072435150"><a name="p92072435150"></a><a name="p92072435150"></a>创建的附加信息。</p>
...
<p id="p12108241564"><a name="p12108241564"></a><a name="p12108241564"></a>包年包月的弹性IP带宽计费类型只能按照带宽计费。</p>
</div></div>
</li></ul>
</td>
</tr>
...
## 创建的extendparam字段数据结构说明<a name="section9232164884010"></a>

该字段被如下接口使用：

创建云服务器 /v1.1/\{project\_id\}/cloudservers

**表 6**  创建的extendparam字段数据结构说明
...
<div class="note" id="note991724692911"><a name="note991724692911"></a><a name="note991724692911"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul1591744622911"></a><a name="ul1591744622911"></a><ul id="ul1591744622911"><li>仅interruption_policy=immediate 时该字段有效 。</li><li>spot_duration_hours大于0。最大值由预测系统给出可以从flavor的extra_specs的cond:spot_block:operation:longest_duration_hours字段中查询。</li></ul>
</div></div>
</td>
</tr>
...
<div class="note" id="note1191774602912"><a name="note1191774602912"></a><a name="note1191774602912"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul6917184617292"></a><a name="ul6917184617292"></a><ul id="ul6917184617292"><li>仅spot_duration_hours&gt;0 时该字段有效。</li><li>spot_duration_hours小于6时，spot_duration_count值必须为1。</li><li>spot_duration_hours等于6时，spot_duration_count大于等于1。<p id="p14918114662915"><a name="p14918114662915"></a><a name="p14918114662915"></a>spot_duration_count的最大值由预测系统给出可以从flavor的extra_specs的cond:spot_block:operation:longest_duration_count字段中查询。</p>
</li></ul>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="47.05%" headers="mcps1.2.5.1.4 "><p id="p109181446152916"><a name="p109181446152916"></a><a name="p109181446152916"></a>竞价实例中断策略，当前支持immediate。</p>
<div class="note" id="note891884692915"><a name="note891884692915"></a><a name="note891884692915"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul3918204616292"></a><a name="ul3918204616292"></a><ul id="ul3918204616292"><li>当interruption_policy=immediate时表示释放策略为立即释放。</li></ul>
</div></div>
</td>
</tr>
...
<div class="note" id="note682265251319"><a name="note682265251319"></a><a name="note682265251319"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul10822452191317"></a><a name="ul10822452191317"></a><ul id="ul10822452191317"><li>仅interruption_policy=immediate 时该字段有效 。</li><li>spot_duration_hours大于0。最大值由预测系统给出可以从flavor的extra_specs的cond:spot_block:operation:longest_duration_hours字段中查询。</li></ul>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="47.45525447455255%" headers="mcps1.2.5.1.4 "><p id="p2822452181318"><a name="p2822452181318"></a><a name="p2822452181318"></a>竞价实例中断策略，当前支持immediate。</p>
<div class="note" id="note68220520138"><a name="note68220520138"></a><a name="note68220520138"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul5822175201312"></a><a name="ul5822175201312"></a><ul id="ul5822175201312"><li>当interruption_policy=immediate时表示释放策略为立即释放。</li></ul>
</div></div>
</td>
</tr>
</tbody>
...
<p id="zh-cn_topic_0020212668_p1295251611495"><a name="zh-cn_topic_0020212668_p1295251611495"></a><a name="zh-cn_topic_0020212668_p1295251611495"></a>云服务器组的ID可以从控制台或者参考<a href="查询云服务器组列表-21.md">查询云服务器组列表</a>获取。</p>
...
<td class="cellrowborder" valign="top" width="55.35%" headers="mcps1.2.4.1.3 "><p id="p15755185203413"><a name="p15755185203413"></a><a name="p15755185203413"></a>云服务器组ID，UUID格式。</p>
<p id="p775517524342"><a name="p775517524342"></a><a name="p775517524342"></a>云服务器组的ID可以从控制台或者参考<a href="查询云服务器组列表-21.md">查询云服务器组列表</a>获取。</p>
</td>
</tr>
