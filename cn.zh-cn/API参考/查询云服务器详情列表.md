...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=ECS&api=ListServersDetails)中直接运行调试该接口。
...
<p id="p273217563714"><a name="p273217563714"></a><a name="p273217563714"></a>当前页面数，默认为1，取值大于等于0。</p>
<p id="p20184253142913"><a name="p20184253142913"></a><a name="p20184253142913"></a>取值为0时系统默认返回第1页，与取值为1相同。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="48.51485148514852%" headers="mcps1.2.5.1.4 "><p id="p16768629"><a name="p16768629"></a><a name="p16768629"></a>云服务器规格ID,<span>已上线的规格请参见《弹性云服务器用户指南》的“规格清单”章节。</span></p>
</td>
</tr>
...
<div class="note" id="note124521913175616"><a name="note124521913175616"></a><a name="note124521913175616"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="ecs_03_0204_p213418685710"><a name="ecs_03_0204_p213418685710"></a><a name="ecs_03_0204_p213418685710"></a>当云服务器处于中间状态时，查询范围如下：</p>
...
<p id="p58503618"><a name="p58503618"></a><a name="p58503618"></a>每页默认值是25，最多返回1000台云服务器的信息，如果数据量过大建议设置成100。</p>
</td>
</tr>
...
<p id="p1099434663417"><a name="p1099434663417"></a><a name="p1099434663417"></a>示例：查询的云服务器列表中不包含裸金属服务器，该字段设置如下：not-tags=__type_baremetal</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.54%" headers="mcps1.2.4.1.3 "><p id="p467113651412"><a name="p467113651412"></a><a name="p467113651412"></a>弹性云服务器详情列表，具体参照<a href="查询云服务器详情.md#zh-cn_topic_0057972887_table61673566">表3</a>接口。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50.54%" headers="mcps1.2.4.1.3 "><p id="p1871461510197"><a name="p1871461510197"></a><a name="p1871461510197"></a>弹性云服务器的总数。</p>
</td>
</tr>
</tbody>
</table>
