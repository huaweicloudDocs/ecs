...
<td class="cellrowborder" valign="top" width="49.309999999999995%" headers="mcps1.2.4.1.3 "><p id="p5450940410290"><a name="p5450940410290"></a><a name="p5450940410290"></a>Job操作的对象。根据不同Job类型，显示不同的内容，<span id="text52931715133719"><a name="text52931715133719"></a><a name="text52931715133719"></a>云服务器</span>相关操作显示server_id，网卡相关操作显示nic_id。详情请参见<a href="#table2577901102930">表5</a>。</p>
</td>
</tr>
