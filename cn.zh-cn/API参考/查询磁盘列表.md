# 查询磁盘列表<a name="ZH-CN_TOPIC_0065817709"></a>
...
-   该API准备废弃，从微版本2.36开始，调用该接口将报404错误。建议直接使用对应的存储服务接口["查询云硬盘列表（OpenStack原生 v2）"](https://support.huaweicloud.com/api-evs/zh-cn_topic_0058762430.html)。
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0057973209_p11866445"><a name="zh-cn_topic_0057973209_p11866445"></a><a name="zh-cn_topic_0057973209_p11866445"></a>List</p>
</td>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0057973209_p48703693"><a name="zh-cn_topic_0057973209_p48703693"></a><a name="zh-cn_topic_0057973209_p48703693"></a>Dict</p>
</td>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0057973209_p26712781"><a name="zh-cn_topic_0057973209_p26712781"></a><a name="zh-cn_topic_0057973209_p26712781"></a>Int</p>
</td>
...
## 示例<a name="zh-cn_topic_0057973209_section58931151"></a>

-   请求示例

    ```
    GET /v2/b84c367e4d1047fc9b54f28b400ddbc2/os-volumes
    GET /v2.1/b84c367e4d1047fc9b54f28b400ddbc2/os-volumes
    ```
