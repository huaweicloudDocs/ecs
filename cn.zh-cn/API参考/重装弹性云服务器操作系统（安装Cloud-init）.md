...
<td class="cellrowborder" valign="top" width="43.24%" headers="mcps1.2.5.1.4 "><p id="p4078366294136"><a name="p4078366294136"></a><a name="p4078366294136"></a>重装<span id="text177017515244"><a name="text177017515244"></a><a name="text177017515244"></a>云服务器</span>过程中注入用户数据。</p>
<p id="p3150863894136"><a name="p3150863894136"></a><a name="p3150863894136"></a>支持注入文本、文本文件。注入内容最大长度32KB。注入内容，需要进行base64格式编码。</p>
