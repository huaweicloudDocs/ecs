# GPU加速型实例安装GRID/vGPU驱动<a name="ZH-CN_TOPIC_0149610914"></a>
...
1.  请根据[表2](#table230940145218)对应操作系统[下载驱动安装包](https://www.nvidia.com/grid-eval)。
    ...
    **表 2**  GPU实例类型支持的vGPU/GRID驱动版本
    ...
    <td class="cellrowborder" valign="top" width="38.84388438843885%" headers="mcps1.2.6.1.3 "><a name="ul61637167455"></a><a name="ul61637167455"></a><ul id="ul61637167455"><li>Windows Server 2016 Standard 64bit</li><li>Windows Server 2012 R2 Standard 64bit</li><li>Ubuntu 16.04 64bit</li><li>CentOS 7.5 64bit</li></ul>
    </td>
