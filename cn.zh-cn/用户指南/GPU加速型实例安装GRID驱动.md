...
1.  请根据[表1](#table188851534175019)对应操作系统下载驱动安装包。
    ...
    **表 1**  GPU实例类型支持的GRID驱动版本
    ...
    <td class="cellrowborder" valign="top" width="38.84388438843885%" headers="mcps1.2.6.1.3 "><a name="ul1376510289287"></a><a name="ul1376510289287"></a><ul id="ul1376510289287"><li>Windows Server 2016 Standard 64bit</li><li>Ubuntu Server 16.04 64bit</li><li>CentOS 7.5 64bit</li></ul>
    </td>
