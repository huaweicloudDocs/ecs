...
1.  请根据[表1](#table188851534175019)对应操作系统下载驱动安装包。
    ...
    **表 1**  GPU实例类型支持的GRID驱动版本
    ...
    <td class="cellrowborder" valign="top" width="23.352335233523352%" headers="mcps1.2.6.1.4 "><p id="p48111812192311"><a name="p48111812192311"></a><a name="p48111812192311"></a>按需选择版本</p>
    </td>
