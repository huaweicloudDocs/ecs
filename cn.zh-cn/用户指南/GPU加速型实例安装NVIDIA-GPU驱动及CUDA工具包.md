...
使用GPU加速型弹性云服务器时，需确保云服务器已安装GPU驱动和CUDA工具包，否则无法实现计算加速功能。本节操作介绍P2v型云服务器安装NVIDIA GPU驱动及CUDA工具包的操作步骤。
...
-   安装NVIDIA驱动
    -   [Linux操作系统云服务器安装NVIDIA GPU驱动](#section1728514576397)
    -   [Windows操作系统云服务器安装NVIDIA GPU驱动](#section244363219171)
...
## Linux操作系统云服务器安装NVIDIA GPU驱动<a name="section1728514576397"></a>

以下操作以Ubuntu 16.04 64bit操作系统，P2v实例安装CUDA 10.1对应的NVIDIA GPU驱动为例。
...
2.  根据操作系统选择命令更新系统软件。
    ...
    -   CentOS
        ...
        更新内核版本：**yum install kernel-devel-\`uname -r\`**
...
## Windows操作系统云服务器安装NVIDIA GPU驱动<a name="section244363219171"></a>

以下操作以Windows Server 2012 R2 Standard 64bit操作系统，P2v实例安装CUDA 10.1对应的NVIDIA GPU驱动为例。
...
1.  登录GPU弹性云服务器。
2.  在CUDA下载页面中，按照[NVIDIA GPU驱动及CUDA工具包获取方式](NVIDIA-GPU驱动及CUDA工具包获取方式.md)中的对应的索引项在页面中进行选择。
...
1.  登录弹性云服务器。
2.  在CUDA下载页面中，按照[CUDA工具包下载地址](NVIDIA-GPU驱动及CUDA工具包获取方式.md#section10203125783920)中的对应的索引项在页面中进行选择。
