...
如果本地主机为Windows操作系统，可以按照下面方式登录弹性云服务器。
...
2.  运行PuTTY。
3.  单击“Session”。
    1.  Host Name \(or IP address\)：输入弹性云服务器的弹性公网IP。
    2.  Port：输入 22。
...
5.  单击“Open”。
    ...
    如果首次登录弹云服务器，PuTTY会显示安全警告对话框，询问是否接受服务器的安全证书。单击“是”将证书保存到本地注册表中。

6.  建立到弹性云服务器的SSH连接后，根据提示输入用户名和密码登录弹性云服务器。
