...
4.  安装新版本PV driver。
    1.  下载PV Driver的安装包。
        ...
        PV Driver下载地址：[https://ecs-instance-driver.obs.myhwclouds.com/pvdriver-windows.zip](https://ecs-instance-driver.obs.myhwclouds.com/pvdriver-windows.zip)
...
6.  <a name="li1950201211120"></a>安装或升级UVP VMTools。
    1.  下载UVP VMTools的安装包。
        ...
        UVP VMTools下载地址：[https://ecs-instance-driver.obs.myhwclouds.com/vmtools-windows.zip](https://ecs-instance-driver.obs.myhwclouds.com/vmtools-windows.zip)
