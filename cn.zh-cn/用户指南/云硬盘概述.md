...
这些类型的性能特点和价格有所不同，您可根据应用程序要求选择您所需的云硬盘。更多关于云硬盘规格、性能等信息，请参见《[云硬盘用户指南](https://support.huaweicloud.com/productdesc-evs/zh-cn_topic_0044524691.html)》。

## 相关链接<a name="section33771043101211"></a>

-   [挂载磁盘](挂载磁盘.md)
-   [初始化Windows数据盘](https://support.huaweicloud.com/qs-ecs/zh-cn_topic_0085634796.html)
