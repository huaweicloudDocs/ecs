...
<p id="p661917247101"><a name="p661917247101"></a><a name="p661917247101"></a>Windows系统使用keypairs创建云服务器初始化时cloudbase-init用于保存密文密码。</p>
</td>
</tr>
...
<p id="p465163616106"><a name="p465163616106"></a><a name="p465163616106"></a>用户根据需要自行指定脚本和配置文件用于云服务器初始化，详细操作请参考<a href="用户数据注入.md">用户数据注入</a>。</p>
...
<p id="p11608355141017"><a name="p11608355141017"></a><a name="p11608355141017"></a>对弹性云服务器获取临时的AK、SK，需要在IAM上对op_svc_ecs帐户授权，并对相应的云服务器资源进行授权委托管理。</p>
</td>
</tr>
...
-   示例
    ...
    **curl http://169.254.169.254/openstack/latest/user\_data**
    ...
    >![](public_sys-resources/icon-note.gif) **说明：**   
    >如果创建云服务器时未注入用户数据，此时，该接口的查询结果是404，如[图1](#fig4761957537)所示。  
...
>![](public_sys-resources/icon-note.gif) **说明：**   
>-   您如果需要在弹性云服务器获取临时的AK、SK，需要在IAM上对op\_svc\_ecs帐户授权，并对相应的云服务器资源进行授权委托管理。  
