...
<th class="cellrowborder" valign="top" width="22.919999999999998%" id="mcps1.2.4.1.2"><p id="p304933271680"><a name="p304933271680"></a><a name="p304933271680"></a>实例元数据项</p>
</th>
<th class="cellrowborder" valign="top" width="52.59%" id="mcps1.2.4.1.3"><p id="p213207321680"><a name="p213207321680"></a><a name="p213207321680"></a>约束说明</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p175787921680"><a name="p175787921680"></a><a name="p175787921680"></a>/meta_data.json</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p426193551680"><a name="p426193551680"></a><a name="p426193551680"></a>查询<span id="text25115134316"><a name="text25115134316"></a><a name="text25115134316"></a>弹性云服务器</span>的元数据信息。</p>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p163874991680"><a name="p163874991680"></a><a name="p163874991680"></a>/password</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p409248351680"><a name="p409248351680"></a><a name="p409248351680"></a>查询<span id="text1731195174317"><a name="text1731195174317"></a><a name="text1731195174317"></a>弹性云服务器</span>的密码。</p>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p11850321680"><a name="p11850321680"></a><a name="p11850321680"></a>/user_data</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p98983401680"><a name="p98983401680"></a><a name="p98983401680"></a>查询<span id="text102291844311"><a name="text102291844311"></a><a name="text102291844311"></a>弹性云服务器</span>的用户数据。</p>
<p id="p465163616106"><a name="p465163616106"></a><a name="p465163616106"></a>用户根据需要自行指定脚本和配置文件用于<span id="text1142815910436"><a name="text1142815910436"></a><a name="text1142815910436"></a>弹性云服务器</span>初始化，详细操作请参考<a href="用户数据注入.md">用户数据注入</a>。</p>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p21457114512"><a name="p21457114512"></a><a name="p21457114512"></a>/network_data.json</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p31455115119"><a name="p31455115119"></a><a name="p31455115119"></a>查询<span id="text114991810194314"><a name="text114991810194314"></a><a name="text114991810194314"></a>弹性云服务器</span>的网络信息。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p714571205111"><a name="p714571205111"></a><a name="p714571205111"></a>/securitykey</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p17145915518"><a name="p17145915518"></a><a name="p17145915518"></a>获取临时的AK、SK。</p>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p10396761161746"><a name="p10396761161746"></a><a name="p10396761161746"></a>/meta-data/hostname</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p45518664161746"><a name="p45518664161746"></a><a name="p45518664161746"></a>查询<span id="text12349212114318"><a name="text12349212114318"></a><a name="text12349212114318"></a>弹性云服务器</span>的主机名称。</p>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p24758917161746"><a name="p24758917161746"></a><a name="p24758917161746"></a>/meta-data/instance-type</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p21785021161746"><a name="p21785021161746"></a><a name="p21785021161746"></a>查询<span id="text4332716144310"><a name="text4332716144310"></a><a name="text4332716144310"></a>弹性云服务器</span>的规格名称。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p177222426305"><a name="p177222426305"></a><a name="p177222426305"></a>/meta-data/local-ipv4</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p39741144528"><a name="p39741144528"></a><a name="p39741144528"></a>查询<span id="text395631674313"><a name="text395631674313"></a><a name="text395631674313"></a>弹性云服务器</span>的固定IP地址。</p>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p2079227616190"><a name="p2079227616190"></a><a name="p2079227616190"></a>/meta-data/placement/availability-zone</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p1219338216190"><a name="p1219338216190"></a><a name="p1219338216190"></a>查询<span id="text3571101744315"><a name="text3571101744315"></a><a name="text3571101744315"></a>弹性云服务器</span>的AZ信息。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p631251216190"><a name="p631251216190"></a><a name="p631251216190"></a>/meta-data/public-ipv4</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p1836582505313"><a name="p1836582505313"></a><a name="p1836582505313"></a>查询<span id="text39871811433"><a name="text39871811433"></a><a name="text39871811433"></a>弹性云服务器</span>的弹性公网IP地址。</p>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p158411821163117"><a name="p158411821163117"></a><a name="p158411821163117"></a>/meta-data/public-keys/0/openssh-key</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p2942083216190"><a name="p2942083216190"></a><a name="p2942083216190"></a>查询<span id="text1265116182433"><a name="text1265116182433"></a><a name="text1265116182433"></a>弹性云服务器</span>的公钥。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p4362812316190"><a name="p4362812316190"></a><a name="p4362812316190"></a>/user-data</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p5919884816190"><a name="p5919884816190"></a><a name="p5919884816190"></a>查询<span id="text413971918432"><a name="text413971918432"></a><a name="text413971918432"></a>弹性云服务器</span>的用户数据。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="22.919999999999998%" headers="mcps1.2.4.1.2 "><p id="p21312452162159"><a name="p21312452162159"></a><a name="p21312452162159"></a>/meta-data/security-groups</p>
</td>
<td class="cellrowborder" valign="top" width="52.59%" headers="mcps1.2.4.1.3 "><p id="p7578912162159"><a name="p7578912162159"></a><a name="p7578912162159"></a>查询<span id="text6691121974319"><a name="text6691121974319"></a><a name="text6691121974319"></a>弹性云服务器</span>所使用的安全组名称。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="54.690000000000005%" headers="mcps1.2.4.1.3 "><p id="p6242103211134"><a name="p6242103211134"></a><a name="p6242103211134"></a><span id="text2323102614436"><a name="text2323102614436"></a><a name="text2323102614436"></a>弹性云服务器</span>所属的虚拟私有云ID</p>
</td>
</tr>
...
-   示例：
    ...
    **curl http://169.254.169.254/openstack/latest/meta\_data.json**
    ...
    Winodows操作系统：以使用Invoke-RestMethod工具为例，介绍查询弹性云服务器元数据的方法。
...
-   示例
    ...
    **Invoke-RestMethod** **http://169.254.169.254/openstack/latest/user\_data**
    ...
    >![](public_sys-resources/icon-note.gif) **说明：** 
    >如果创建弹性云服务器时未注入用户数据，此时，该接口的查询结果是404，如[图1](#fig124601338153316)所示。
...
-   示例
    ...
    **Invoke-RestMethod http://169.254.169.254/openstack/latest/securitykeylatest**
