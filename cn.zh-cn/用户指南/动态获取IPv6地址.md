...
-   请确保云服务器规格支持IPv6功能。
    ...
    不同区域、不同可用区支持IPv6双栈的云服务器规格不同。ECS是否支持IPv6双栈，请选择区域、可用区后，以控制台的显示为准，查询方法如[图1](#zh-cn_topic_0129883696_fig92794512219)所示。

    **图 1**  查询支持IPv6的ECS规格<a name="zh-cn_topic_0129883696_fig92794512219"></a>  
    ![](figures/查询支持IPv6的ECS规格.png "查询支持IPv6的ECS规格")

    如[图1](#zh-cn_topic_0129883696_fig92794512219)所示，当ECS规格列表中包含“IPv6”参数，且取值为“是”时，表示该ECS规格支持IPv6。
...
-   请确保创建云服务器时已选择“自动分配IPv6地址”。
    ...
    **图 2**  选择“自动分配IPv6地址”<a name="zh-cn_topic_0129883696_fig1422543474910"></a>  
    ...
    >若创建云服务器时未开启“自动分配IPv6地址”，请参考[Linux操作系统（自动配置启用IPv6）](#zh-cn_topic_0129883696_section106971627556)进行配置。
    ...
    **ipconfig**
    ...
    -   如果已启用IPv6，则会显示IPv6的地址。
        ...
        **图 9**  显示IPv6的地址<a name="zh-cn_topic_0129883696_fig15843174118353"></a>  
        ![](figures/显示IPv6的地址-15.png "显示IPv6的地址-15")
    ...
    -   如果显示只有本地链接IPv6地址，则表示无法动态获取到IPv6地址。请执行[2](#zh-cn_topic_0129883696_li163121855114515)。
        ...
        **图 10**  本地链接IPv6地址<a name="zh-cn_topic_0129883696_fig14741755113514"></a>  
        ![](figures/本地链接IPv6地址-16.png "本地链接IPv6地址-16")
    ...
    -   如果未启用IPv6，则不会显示IPv6的地址。请执行[3](#zh-cn_topic_0129883696_li17876141612467)。
        ...
        **图 11**  未启用IPv6<a name="zh-cn_topic_0129883696_fig1176055812351"></a>  
        ![](figures/未启用IPv6-17.png "未启用IPv6-17")
...
2.  <a name="zh-cn_topic_0129883696_li163121855114515"></a>配置动态获取IPv6。
    ...
    5.  勾选“Internet协议版本 6 \(TCP/IPv6\)”，然后单击“确定”。
        ...
        **图 12**  配置动态获取IPv6<a name="zh-cn_topic_0129883696_fig1018018532017"></a>  
        ![](figures/配置动态获取IPv6-18.png "配置动态获取IPv6-18")
