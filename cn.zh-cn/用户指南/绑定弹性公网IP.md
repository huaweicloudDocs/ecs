# 绑定弹性公网IP<a name="ZH-CN_TOPIC_0174917535"></a>
...
4.  在弹性云服务器列表中，找到待绑定弹性公网IP的弹性云服务器，单击“操作”列下的“更多 \> 网络设置 \> 绑定弹性公网IP”。
5.  选择弹性公网IP。
...
6.  设置“释放行为”。
    ...
    对于勾选了“随实例释放”的弹性公网IP，将在删除云服务器同时执行删除。

7.  单击“确定”。

    完成绑定后，可以在云服务器列表页查看已绑定的弹性公网IP。
